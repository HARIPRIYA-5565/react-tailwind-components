...
export function SignUp(){
    return(
        <>
        <main className="min-h-screen flex flex-col items-center justify-center space-y-10 py-12 px-4 ">
				<div>
				...
				<div className="max-w-md w-full mx-auto shadow rounded-lg p-7 space-y-6">
					...
					<div>
						<button className="w-full bg-indigo-600 text-white rounded-md p-2  hover:bg-blue-700">
							Sign in
						</button>
					</div>
					...
					<div className="grid grid-cols-3 gap-2  text-xl">
						<div className="border-2 h-11 rounded-md p-3 px-12 text-center cursor-pointer hover:border-gray-600">
							<svg
